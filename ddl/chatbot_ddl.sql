...
/*!50106 DROP EVENT IF EXISTS `call_procedure1` */;
DELIMITER ;;
...
/*!50106 CREATE*/ /*!50117 DEFINER=`root`@`localhost`*/ /*!50106 EVENT `call_procedure1` ON SCHEDULE EVERY 1 WEEK STARTS CURRENT_TIMESTAMP + INTERVAL (6 - WEEKDAY(CURRENT_TIMESTAMP)) DAY + INTERVAL 23 HOUR + INTERVAL 59 MINUTE + INTERVAL 59 SECOND ON COMPLETION NOT PRESERVE ENABLE DO BEGIN
    CALL save_guiness();
  END */ ;;
...
-- Dump completed on 2023-09-19 22:55:00
